const audioPuzzlesData = [
    ...
    { word: "Monkey", audio: "./Audio/monkey.mp3" },
    { word: "Lion", audio: "./Audio/lion.mp3" },
    { word: "Bear", audio: "./Audio/bear.mp3" },
    { word: "Wolf", audio: "./Audio/wolf.mp3" },
    { word: "Giraffe", audio: "./Audio/giraffe.mp3" },
    { word: "Fox", audio: "./Audio/fox.mp3" },
    { word: "Zebra", audio: "./Audio/zebra.mp3" }
];
