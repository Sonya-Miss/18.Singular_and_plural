...
const carouselImages = [
    { src: "./Pictures/8.jpg", alt: "To be" },
    { src: "./Pictures/9.jpg", alt: "Days of the week" },
    { src: "./Pictures/10.jpg", alt: "Dom animals" },
    { src: "./Pictures/11.jpg", alt: "W animals" },
    { src: "./Pictures/12.jpg", alt: "Vegetables" },
    { src: "./Pictures/13.jpg", alt: "Fruits" }
];

// Зображення для каруселі 2

const carouselImages2 = [
    { src: "./Pictures/example.jpg", alt: "Plural" }
